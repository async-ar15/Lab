...
graph LR
    ...
    Proxy -->|Forward Request| Internet[Internet / Target Server]
    Internet -->|Response| Proxy
    Proxy -->|Relay Response| Client
```
...
```mermaid
graph LR
    Client[Client] -->|Request| RP[Reverse Proxy]
    RP -->|Forward| Server1[Backend Server 1]
    RP -->|Forward| Server2[Backend Server 2]
    Server1 -->|Response| RP
    Server2 -->|Response| RP
    RP -->|Relay Response| Client
```
