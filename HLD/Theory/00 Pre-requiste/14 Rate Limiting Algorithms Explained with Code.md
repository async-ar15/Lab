...
```mermaid
graph TD
    Req[Incoming Burst Requests] --> Bucket[(Queue / Bucket)]
    Bucket -->|Overflow if Full| Drop[Drop Request]
    Bucket -->|Leak at Constant Rate| Process[Process Request]
```
