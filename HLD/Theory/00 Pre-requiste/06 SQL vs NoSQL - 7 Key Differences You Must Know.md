...
| Row Key (UserID) | Columns... |
|------------------|------------|
| User 1 | Page1, Page2, Purchase1, Purchase2 |
| User 2 | Page1, Page2, Purchase1 |
| User 3 | Page1, Purchase1 |
...
```mermaid
graph TD
    John[John] -->|PLACED_ORDER| Laptop[Laptop]
    Mike[Mike] -->|PLACED_ORDER| Smartphone[Smartphone]
    Ron[Ron] -->|PLACED_ORDER| Headphones[Headphones]
```
...
**Example: Cassandra Conditional Update (Lightweight Transaction):**
...
| Feature | SQL | NoSQL |
|---------|-----|-------|
| **Data Model** | Relational (Tables, Rows, Columns) | Flexible (Key-Value, Document, Column, Graph) |
| **Schema** | Rigid, Predefined | Dynamic, Schema-less |
| **Scalability** | Vertical Scaling (Scale-up) | Horizontal Scaling (Scale-out) |
| **Query Language** | Standardized (SQL) | Varies by Database Type |
| **Transaction Support**| Strong ACID Compliance | BASE Model, Eventual Consistency |
| **Performance** | Optimized for Complex Queries, Joins | Optimized for High Throughput, Scalability |
| **Use Cases** | Finance, Healthcare, ERP Systems | Social Media, IoT, Big Data Analytics |
