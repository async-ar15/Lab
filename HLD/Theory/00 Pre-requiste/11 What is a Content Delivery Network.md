...
DNS Resolution – The browser sends a DNS query to resolve the web content address (e.g., https://cdn.example.com/images/logo.png) into an IP address. The DNS return the nearest CDN edge server’s IP address rather than the origin server.
